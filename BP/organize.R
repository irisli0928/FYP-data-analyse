setwd("F:/Tools/Rworkspace/FYP-data-analysis/BP")
library("ggplot2")
library("BayesFactor")
library("XLConnect")
library("ggpubr")
...
write.csv(data, "F:/Tools/Rworkspace/FYP-data-analysis/BP/output/fit.csv")

write.csv(distance, "F:/Tools/Rworkspace/FYP-data-analysis/BP/output/distanceBP.csv")
write.csv(accuracy, "F:/Tools/Rworkspace/FYP-data-analysis/BP/output/accuracyBP.csv")
