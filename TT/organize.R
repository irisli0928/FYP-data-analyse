...
write.csv(data, "F:/Tools/Rworkspace/FYP-data-analysis/TT/output/fit.csv")

write.csv(distance, "F:/Tools/Rworkspace/FYP-data-analysis/TT/output/distanceTT.csv")
write.csv(accuracy, "F:/Tools/Rworkspace/FYP-data-analysis/TT/output/accuracyTT.csv")
