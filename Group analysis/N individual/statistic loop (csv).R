...
write.csv(dataTiralSave, "NtrialLog.csv", row.names = TRUE)
...
write.csv(dataBlockSave, "Nblocklog.csv", row.names = TRUE)
...
write.csv(LinearSaveT, "NtrialLinear.csv", row.names = TRUE)
...
write.csv(LinearSaveB, "NlockLinear.csv", row.names = TRUE)
