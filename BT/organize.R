...
write.csv(data, "F:/Tools/Rworkspace/FYP-data-analysis/BT/output/fit.csv")

write.csv(distance, "F:/Tools/Rworkspace/FYP-data-analysis/BT/output/distanceBT.csv")
write.csv(accuracy, "F:/Tools/Rworkspace/FYP-data-analysis/BT/output/accuracyBT.csv")
